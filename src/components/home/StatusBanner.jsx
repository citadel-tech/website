        ...
        <div className="type-caption flex flex-wrap items-center gap-3 font-mono uppercase tracking-[0.14em]">
          {releaseTag && releaseUrl && (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-md border border-orange/20 bg-orange/8 px-3.5 py-2 text-cream/90 transition-all duration-200 hover:bg-orange/15 hover:border-orange/35"
            >
              LATEST: {releaseTag} ↗
            </a>
          )}
          ...
          <span className="inline-flex items-center gap-2 rounded-md border border-cream/10 bg-cream/[0.03] px-3.5 py-2 text-cream/70">
